...
.button-cart span{background:#9bc2f5;color:#f0f0f0;border:3px solid #a1c6f74d;-webkit-border-radius:3px;-webkit-transition:-webkit-transform .2s ease-in-out;display:inline-block;padding:1px 4px;text-transform:uppercase;font-family:inherit;font-weight:700;font-size:var(--button-font-primary)}
