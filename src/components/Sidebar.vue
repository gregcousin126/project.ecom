...
<nav class="navbar" id="navbar">
 <ul class="navbar-nav">
      ...
      <li class="nav-item" >
        <router-link to="/cart" ><a class="nav-link"  >
          ...
          <span class="link-text">Cart</span></a></router-link>
      </li>
     	<!-- <li class="nav-item">
...
margin-left: -44px;
height: 19px;
margin: -.3rem 1rem 0rem 2.3rem;
/* margin-left: 33px; */
border-radius: 16px;
/* top: 7px; */
z-index: 1;
border: 2px solid var(--bg-low-opacity);
/* left: 35px; */
padding: 0;
...
font-weight: 600;
  ...
  /* position:absolute;width:22px;border-radius:16px;top:8px;z-index:1;border:2px solid var(--bg-low-opacity);left:41px;padding:0;background:var(--blue-primary);color:#fff;font-size:12px;font-weight:600 */
...
.nav-link svg{width:1.9rem;min-width:1.9rem;margin:0 1rem}
